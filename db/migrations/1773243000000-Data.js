module.exports = class Data1773243000000 {
    ...
    async up(db) {
        ...
        await db.query(`ALTER TABLE "assertion_added" ADD "metadata" bytea NOT NULL DEFAULT '\\x'`)
        await db.query(`ALTER TABLE "assertion_added" ADD "proof" bytea NOT NULL DEFAULT '\\x'`)
